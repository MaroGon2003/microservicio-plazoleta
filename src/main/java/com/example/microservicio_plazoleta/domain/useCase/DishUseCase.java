...
public class DishUseCase implements IDishServicePort {
    ...
    public void saveDish(DishModel dish) {
        ...
        if (dish == null) {
            throw new NullPointerException(MessageConstants.DISH_IS_NULL);
        }
        ...
        if (category == null) {
            throw new CategoryNotFoundException(MessageConstants.CATEGORY_NOT_FOUND);
        }
    ...
    public DishModel updateDish(Long id, Long ownerId, DishModel dish) {
        ...
        if (!restaurant.getIdOwner().equals(ownerId)) {
            throw new OwnerDishUpdateException(MessageConstants.OWNER_DISH_UPDATE);
        }
    ...
    public List<DishModel> getAllDishes(Long restaurantId, int pageNumber, int pageSize, Long categoryId) {
        ...
        if (dishesList.isEmpty()) {
            throw new NullPointerException(MessageConstants.DISH_LIST_IS_EMPTY);
        }
